...
namespace WPFPWZ.components.objects
{
    class Object_Orders
    {
        ...
        //public Object_Orders(int id_order, int id_rackAndCell, string? num_phone, DateTime datetime_accept, DateTime dateTime_end)
        //{
        ...
        public Object_Orders(int id_order, string? num_phone, int rack, int cell, DateTime data_end)
        {
            Id_order = id_order;
            Num_phone = num_phone;
            //Id_rack = rack;
